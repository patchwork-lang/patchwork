...
flowchart TB
    ...
    CodeEditor -->|stdio| Agent1
    CodeEditor -->|stdio| Agent2
    CodeEditor -.-> More
```
...
flowchart TB
    ...
    CodeEditor -->|"MCP Configuration"| Agent
    Agent -->|"MCP"| Server1
    Agent -.->|"MCP"| ServerN
```
...
flowchart TB
    ...
    CE -.->|"MCP Proxy Configuration"| AG
    AG <-->|"MCP over stdio"| MP
    MP <-.->|"MCP over socket"| CE
```
